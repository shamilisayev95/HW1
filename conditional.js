...
console.log("getSumIsEvenNum", getSumIsEvenNum(7, 2));
...
console.log("cordinateQuarterFinder", cordinateQuarterFinder(2,5));
...
console.log("scoreRaiting", scoreRaiting(101));
...
console.log("positivNumberSum",positivNumberSum(-2,2,2));
